...
public class FuncionarioTest {
	...
	public void deve_aceitar_id_valido() {
		assertNotNull(funcionarioTeste.getId());
		assertFalse(getErros(funcionarioTeste).contains("ID não pode ser menor que 1."));
	}
	...
	public void nao_deve_aceitar_id_menor_1() {
		funcionarioTeste.setId(0);
		assertThat(getErros(funcionarioTeste), hasItem("ID não pode ser menor que 1."));
	}
	...
	@Test
	public void nao_deve_aceitar_nome_funcionario_vazio() {
		funcionarioTeste.setNome("");
		assertThat(getErros(funcionarioTeste), hasItem("Nome não pode ser nulo."));
	}
	
	@Test
	public void nao_deve_aceitar_nome_funcionario_espacos() {
		funcionarioTeste.setNome("   ");
		assertThat(getErros(funcionarioTeste), hasItem("Nome não pode ser nulo."));
	}
	...
	@Test
	public void nao_deve_aceitar_email_funcionario_nulo() {
		funcionarioTeste.setEmail(null);
		assertThat(getErros(funcionarioTeste), hasItem("Email não pode ser nulo ou vazio."));
	}
	
	@Test
	public void nao_deve_aceitar_email_funcionario_vazio() {
		funcionarioTeste.setEmail("");
		assertThat(getErros(funcionarioTeste), hasItem("Email não pode ser nulo ou vazio."));
	}
	
	@Test
	public void nao_deve_aceitar_email_funcionario_espacos() {
		funcionarioTeste.setEmail("   ");
		assertThat(getErros(funcionarioTeste), hasItem("Email não pode ser nulo ou vazio."));
	}
	...
	public void to_string_deve_conter_setor() {
		assertTrue("Confere se Setor está no toString",
				funcionarioTeste.toString().contains(funcionarioTeste.getSetor().toString()));
	}
