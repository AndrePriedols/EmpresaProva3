...
public class FornecedorTest {
	...
	@Test
	public void deve_aceitar_telefone_fornecedor_valido() {
		Telefone telefoneTeste = new Telefone();
		fornecedorTeste.setTelefone(telefoneTeste);
		assertFalse(getErros(fornecedorTeste).contains("Telefone não pode ser nulo."));
	}

	@Test
	public void nao_deve_aceitar_telefone_fornecedor_nulo() {
		fornecedorTeste.setTelefone(null);
		assertThat(getErros(fornecedorTeste), hasItem("Telefone não pode ser nulo."));
	}
	...
	public void deve_aceitar_url_valida() {
		assertFalse(getErros(fornecedorTeste).contains("URL do Site inválida."));
	}

	@Test
	public void nao_deve_aceitar_url_invalida() {
		fornecedorTeste.setWebsite("www.site_errado.com");
		assertThat(getErros(fornecedorTeste), hasItem("URL do Site inválida."));
	}

	@Test(timeout = 100)
	public void z00_deve_respeitar_o_get_set_website() {
		fornecedorTeste.setWebsite("www.site_errado.com");
		boolean a = fornecedorTeste.getWebsite() == "www.site_errado.com";
		assertTrue("Get e Set Endereço deve funcionar.", a);
	}
	...
	public void to_string_deve_conter_razao_social() {
		...
		assertTrue("Confere se Razão Social Fornecedor está no toString",
				fornecedorTeste.toString().contains(fornecedorTeste.getRazaoSocial()));
	}
	...
	public void to_string_deve_conter_email() {
		fornecedorTeste.setEmail("geovanemacuser@apple.com");
		assertTrue("Confere se Email Fornecedor está no toString",
				fornecedorTeste.toString().contains(fornecedorTeste.getEmail()));
	}
