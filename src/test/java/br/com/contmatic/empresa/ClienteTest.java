...
public class ClienteTest {
	...
	public void to_string_deve_conter_nome_cliente() {
		...
		assertTrue("Confere se Nome Cliente está no toString",
				clienteTeste.toString().contains(clienteTeste.getNome()));
	}
	...
	public void to_string_deve_conter_email() {
		clienteTeste.setEmail("geovanemacuser@apple.com");
		assertTrue("Confere se Email Cliente está no toString",
				clienteTeste.toString().contains(clienteTeste.getEmail()));
	}
