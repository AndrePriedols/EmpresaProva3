...
public class ValidadorCPF {
	...
	public static String validaCpf(String numeroCpf) {
        impedeCpfNulo(numeroCpf);
        obrigaCpf11Digitos(numeroCpf);
        impedeCaracteresNaoNumericosCpf(numeroCpf);
        impedeCpfTodosDigitosIguais(numeroCpf);
        validadorCpf(numeroCpf);
    ...
    private static void comparaDigitosVerificadoresComRegraCpf(int restoDivisaoSomaPrimeiroDigitoPor11, int primeiroDigitoVerificadorParaNumero, int restoDivisaoSomaSegundoDigitoVerificadorPor11,
    ...
    private static int realizaSomaSegundoDigitoVerificador(String cpf, int somaParaValidarSegundoDigitoVerificador) {
    ...
    private static int realizaSomaPrimeiroDigitoVerificador(String cpf, int somaParaValidarPrimeiroDigitoVerificador) {
        for(int indiceDigitoCpf = PRIMEIRO_DIGITO_CPF ; indiceDigitoCpf <= EXTENSAO_OBRIGATORIA_CPF ; indiceDigitoCpf++) {
    ...
    private static void impedeCpfTodosDigitosIguais(String cpf) {
    ...
    private static void impedeCaracteresNaoNumericosCpf(String cpf) {
